...
**Organ systems** — the eight architectural capabilities of the Team Brain (knowledge, ingestion, context, actions, identity, policy, audit, feedback). See [The 8 organ systems](/reference/anatomy/).
